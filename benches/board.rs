...
fn capture_gen(boards: &[Board]) -> u64 {
    boards
        .iter()
...
fn see_captures(boards: &[Board]) -> u64 {
    let mut ops = 0u64;
    for board in boards {
